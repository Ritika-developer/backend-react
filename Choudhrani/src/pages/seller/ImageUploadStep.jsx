...
// /* -------------------- Sortable Item -------------------- */
// function SortableImage({ id, image, index, isPrimary, onSetPrimary }) {
//   const {
//     attributes,
//     listeners,
//     setNodeRef,
...
//     transition,
//     border: isPrimary ? "2px solid green" : "1px solid #ddd",
//     cursor: "pointer"
//   };
...
//           {isPrimary ? "PRIMARY ⭐" : `Order : ${index + 1}`}
//         </Typography>
//       </Paper>
//     </Grid>
//   );
...
//   const [primaryIndex, setPrimaryIndex] = useState(0); // ✅ FIX
...
//     formData.append("orders", index);   // 🔥 SAME NAME AS CONTROLLER
//     if (img.isPrimary) {
//       primaryIndex = index;
//     }
//   });

//   formData.append("primaryIndex", primaryIndex); // 🔥 REQUIRED PARAM

//   await axiosInstance.post(
//     `/auth/products/${productState.productId}/images`,
//     formData,
//     {
//       params: { variantId }
//     }
